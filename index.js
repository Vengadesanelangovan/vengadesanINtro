...
const profile = {
  name: "Vengadesan",
  role: "CSE Student • Aspiring Frontend/BI Engineer",
  ...
  about:
    "I'm pursuing Computer Science and Engineering at TIET College. I enjoy solving problems, visualizing data, and crafting smooth UI/UX. I’ve won Zonal Level (1st place) in Chess, completed a Python course from YBT, and I’m currently exploring React, Power BI, and modern web tooling.",
  education: [
    { school: "TIET College", degree: "B.E. in Computer Science & Engineering", period: "Present" },
    { school: "Higher Secondary – Vadakrishnapuram School", degree: "HSE", period: "Completed" },
    { school: "Secondary – Vadakrishnapuram School", degree: "SSLC", period: "Completed" },
  ],
  achievements: [
    { title: "Zonal Level Chess – 1st Place", note: "Competitive Chess Winner" },
...
export default function Portfolio() {
  ...
  // Compute public image URL — safe for Vite/CRA (public folder)
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 space-y-10">
        ...
        <section className="grid md:grid-cols-3 gap-6">
          <Card className="md:col-span-2">
            <h2 className="text-2xl font-bold flex items-center gap-2">💡 About</h2>
        ...
        <section>
          ...
          <Card>
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {profile.socials.email ? (
                <a href={`mailto:${profile.socials.email}`} className="inline-flex items-center gap-2 rounded-2xl border px-4 py-2 hover:shadow">
                  <span style={{ fontSize: 14 }}>📧</span> {profile.socials.email}
                </a>
              ) : (
